...
- Tickers tracked: 47 ticker tra azioni USA (tech, finance, energy, defense, pharma, consumer, airlines), ETF (SPY, QQQ, GLD, SLV, XLE, XLF, USO, TLT) e crypto (BTC-USD, ETH-USD, SOL-USD, XRP-USD, DOGE-USD). Lista completa in `bot_telegram/telegram_bot.py` TICKERS.
